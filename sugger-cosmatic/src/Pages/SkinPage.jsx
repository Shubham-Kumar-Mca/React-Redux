...
const SkinPage = () => {
  const ProType = ["Cleansing Water", "Face Mask", "Sheet Mask", "Moisturizer", "Hydrating Stick", "Sunscreen", "Cooling Stick", "Refreshing Mist", "Cleansing Mask", "Serum", "Hydrating Primer", "SCRUB", "Clarifying Spot Gel", "Firming Cream", "Lip Scrub", "Brightening Serum", "Clay Stick Mask", "Hydrating Mist", "Brightening Peel"]
  ...
  useEffect(() => {
    if (location || data.length === 0) {
      ...
      dispatch(grtProductsAPI("SkinData", getParams))
    }
  ...
  return (
    <>
      <div>
          ...
          <div className='d-flex mainho mb-3 '>
            <div className='d-flex pata'>
              ...
              <div className='d-flex'>
                ...
                <div className='homeLink'>
                  <Link to="/skin-care-products"><span className='makupSpan'>Skin Care Products</span></Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          {isLoading && !isError && <h2 style={{ textAlign: "center" }}>Loading.....</h2>}
          {!isLoading && isError && <h2 style={{ textAlign: "center" }}>Error.....</h2>}
        </div>

        <div className='d-flex pt-5 gap all align-item-flex-start'>
